...
{
    public class PlantDiseaseListPageViewModel : BaseViewModel
    {
        ...
        public PlantDiseaseListPageViewModel(INavigationService navigationService, IPlantDiseaseService plantDiseaseService)
        {
